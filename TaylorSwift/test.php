...
<body>
	<canvas id="c" style="z-index:-1;position:absolute;margin:0px;"></canvas>
	<ul>
	    <?php
	    ...
	    ?>
	    <div class="comment" style="background:none;box-shadow: 8px 8px  rgb(<?php echo rand(0,255).','.rand(0,255).','.rand(0,255); ?>)">
	        <li>
	            <p><?php echo $row[1];?></p>
